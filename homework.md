...
We will have two class sessions dedicated to brainstorming presentations.

Propose two project ideas accompanied by three relevant papers each. Project descriptions should include why the question/s being asked are important and obtainable datasets that you could use to address these questions. The point counts below indicate how you will be graded for each idea.
...
Each idea is worth three points, and points are totaled across both ideas. You will submit one Google Slide per idea. The "three relevant papers" should not be overly generic papers (e.g. the technical report for Gemini 3) but instead representative prior work, cited at relevant points in your slide. You will present your two slides in 3-5 minutes to the class. 

### Peer feedback for brainstormed project ideas (5 pts)

A folder of slide decks of groups' brainstorming efforts will be shared with the class, and you are expected to add comments on each other's projects to give feedback, ideas, or ask questions. This will be graded as all or nothing, with extra credit given to those who engage substantially. 
...
The length of this presentation is TBD based on the number of project groups. You will submit your slides on Google Slides before class, and we will compile them into a single mega-slide deck. 
...
During finals week, there will be individual 10 min Q&A (a.k.a. an oral exam) about your final project report, based on project members' contribution statements provided in the report. This exam will be graded in increments of 10 points (so essentially you can only get 0, 10, 20, or 30 points).